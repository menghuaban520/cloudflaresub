...
**[新手从这里开始：三步安装 →](docs/shadowrocket/README.md)**

国内常用服务直连，国外与未知服务跟随首页节点；包含微信、抖音、酷狗等域名分流与少量广告拦截。已有节点即可使用，无需部署下面的 Worker。

当前为 **Rebuild 1.0-beta.2 公开试用版**。beta.1 已收到可连接反馈；DNS 隐私与更多网络环境仍待验证。新手说明包含下载链接、自定义、更新和恢复方法。旧 v5 不作为推荐入口。
